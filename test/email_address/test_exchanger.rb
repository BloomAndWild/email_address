...
class TestExchanger < MiniTest::Test
  def test_exchanger
    e = EmailAddr::Exchanger.new("gmail.com")
  ...
  def test_not_found
    e = EmailAddr::Exchanger.new("oops.gmail.com")
    assert_equal 0, e.mxers.size
  end

    #assert_equal true, a.has_dns_a_record? # example.com has no MX'ers
  #def test_dns
  #  good = EmailAddr::Exchanger.new("gmail.com")
  #  bad  = EmailAddr::Exchanger.new("exampldkeie4iufe.com")
